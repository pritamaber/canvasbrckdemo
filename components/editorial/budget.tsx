  ...
  return (
    <section id="estimate" className="py-24 scroll-mt-16 md:py-36">
      <div className="container-x">
        ...
        <div className="mt-14 grid gap-10 rounded-sm border border-fern/12 bg-ivory p-5 shadow-[0_30px_70px_-50px_rgba(59,74,43,0.6)] sm:p-8 lg:grid-cols-[1fr_1.3fr] lg:gap-14 lg:p-10">
          {/* ————— media ————— */}
          <div className="self-start lg:sticky lg:top-28">
            <div className="relative aspect-[4/3] overflow-hidden rounded-sm">
              {/* CSS crossfade — all slides stay mounted, active one on top */}
              {bhk.imagesE.map((src, i) => (
                <Image
                  key={src}
                  src={src}
              ...
              <div className="absolute bottom-4 left-4">
                ...
                <p className="mt-0.5 text-[10px] font-bold uppercase tracking-[0.22em] text-sky-soft">
              ...
              {bhkOptions.map((b) => (
                <button
                  ...
                  className={`rounded-sm border px-2 py-2.5 text-center transition-all duration-300 ${
                    b.id === bhkId
                      ? "border-fern bg-sage-soft/70"
                      : "border-fern/12 hover:border-fern/40"
                  }`}
                >
                  <span className="block text-[10px] font-bold uppercase tracking-[0.14em] text-forest">
                    {b.id === "4bhk" ? "4 BHK+" : b.label}
                  </span>
                  <span className="mt-1 block font-serif text-[13px] italic text-fern">
                    {formatStartingLakh(b.startingLakh)}
                  </span>
                </button>
              ))}
            </div>
          ...
          <div>
            {/* package */}
            <p className="text-[10px] font-bold uppercase tracking-[0.26em] text-fern/70">
              Package
            </p>
                ...
                return (
                  ...
                  >
                    <span className="flex items-center justify-between">
                      ...
                      {active && <Check size={14} className="text-sky" />}
                    </span>
            ...
            <div className="mt-8 flex items-baseline justify-between">
              ...
              <p className="font-serif text-lg italic text-sky">
            ...
            {/* scope */}
            <p className="mt-8 text-[10px] font-bold uppercase tracking-[0.26em] text-fern/70">
                ...
                return (
                  <label
                    ...
                    className={`flex cursor-pointer items-center gap-3 rounded-sm border px-4 py-3 transition-all duration-300 ${
                      on
                        ? "border-fern/60 bg-sage-soft/50"
                        : "border-fern/12 hover:border-fern/40"
                    }`}
                  >
                    <input
                    ...
                    <span
                      className={`grid h-4.5 w-4.5 shrink-0 place-items-center rounded-[3px] border transition-colors duration-300 ${
                        on ? "border-fern bg-fern" : "border-fern/25"
                      }`}
                    >
                    ...
                    <span
                      className={`text-sm transition-colors duration-300 ${
                        on ? "text-forest" : "text-charcoal/55"
                      }`}
                    >
                      {s.label}
                    </span>
            ...
            {/* result */}
            <div className="mt-10 rounded-sm bg-forest p-6 sm:p-8">
              ...
              <motion.p
                ...
                className="mt-3 font-serif text-4xl text-sky-soft sm:text-5xl"
              >
              ...
              <div className="mt-7 flex flex-wrap items-center gap-3.5">
                <a
                  ...
                  className="inline-flex items-center gap-2.5 rounded-full bg-sky px-7 py-3.5 text-[11px] font-bold uppercase tracking-[0.2em] text-ivory transition-colors duration-300 hover:bg-sky-soft hover:text-forest"
                >
