        ...
        <div className="mt-14 border-t border-charcoal/10">
          {processSteps.map((step, i) => (
            <Reveal key={step.title} delay={0.05 * i}>
              <div className="group grid grid-cols-[4rem_1fr] items-baseline gap-6 border-b border-fern/12 py-9 sm:grid-cols-[7rem_1fr_8rem]">
                <span className="font-serif text-5xl text-sage transition-colors duration-500 group-hover:text-sky sm:text-6xl">
                ...
                <div>
                  ...
                  <p className="mt-3 font-serif text-xs italic text-fern sm:hidden">
                    {step.duration}
                  </p>
                </div>
                <p className="hidden text-right font-serif text-sm italic text-fern sm:block">
                  {step.duration}
                </p>
              </div>
            </Reveal>
